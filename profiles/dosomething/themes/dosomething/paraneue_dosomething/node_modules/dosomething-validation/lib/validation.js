...
var showValidationMessage = function showValidationMessage($field, result) {
  var $fieldLabel = _$2["default"]("label[for='" + $field.attr("id") + "']");
  ...
  if (result.success === true) {
    ...
    _Events2["default"].publish("Validation:InlineError", $fieldLabel.attr("for"));
  }
  ...
  if (result.suggestion) {
    ...
    _Events2["default"].publish("Validation:Suggestion", result.suggestion.domain);
  }
  ...
  _$2["default"](".js-mailcheck-fix").on("click", function (e) {
    e.preventDefault();

    var $field = _$2["default"]("#" + _$2["default"](this).closest("label").attr("for"));
    $field.val(_$2["default"](this).data("suggestion"));
    $field.trigger("blur");

    // If Google Analytics is set up, we fire an event to
    // mark that a suggestion has been made
    _Events2["default"].publish("Validation:SuggestionUsed", _$2["default"](this).text());
  });
...
var validateField = (function (_validateField) {
  function validateField(_x, _x2, _x3) {
    return _validateField.apply(this, arguments);
  }

  validateField.toString = function () {
  ...
  if (validationTrigger) {
    validateField(_$2["default"](validationTrigger));
  }
  ...
  if (isFormField($field)) {
    ...
    if (force || fieldValue !== "") {
      if (validation === "match") {
        var matchFieldValue = _$2["default"]($field.data("validate-match")).val();
    ...
    if (validation === "match") {
      var $matchField = _$2["default"]($field.data("validate-match"));
...
var prepareLabel = function prepareLabel($label) {
  ...
  if ($label.find(".validation").length === 0) {
    var $innerLabel = _$2["default"]("<div class='validation'></div>");
...
var prepareFields = function prepareFields($fields) {
  $fields.each(function () {
    var $field = _$2["default"](this);

    prepareLabel(_$2["default"]("label[for='" + $field.attr("id") + "']"));
 ...
 */
_$2["default"]("body").on("submit", "form", function (event, isValidated) {
  ...
  if (isValidated === true) {
    ...
    $validationFields.each(function () {
      validateField(_$2["default"](this), true, function ($field, result) {
        validatedFields++;
        showValidationMessage($field, result);
        ...
        if (!scrolledToError && result.success === false) {
          ...
          _$2["default"]("html,body").animate({ scrollTop: $field.offset().top - 32 }, 200);
        }
        ...
        if (validatedFields === $validationFields.length) {
          if (validatedResults === $validationFields.length) {
            ...
            _Events2["default"].publish("Validation:Submitted", $form.attr("id"));
            $form.trigger("submit", true);
          } else {
            _Events2["default"].publish("Validation:SubmitError", $form.attr("id"));
...
_$2["default"](function () {
  // Prepare the labels on any `[data-validate]` fields in the DOM at load
  prepareFields(_$2["default"]("body").find("[data-validate]"));
});
