...
var _addCloseButton = function _addCloseButton($el, type, skipForm) {
  switch (type) {
    case "skip":
 ...
 */
var open = function open($el, options) {
  options = options || {};
...
var _cleanup = function _cleanup(scrollOffset) {
 ...
 */
var close = function close(options) {
  options = options || {};
...
var _openHandler = function _openHandler(event) {
  event.preventDefault();
...
var _closeHandler = function _closeHandler(event) {
...
// Export public API:
module.exports = { isOpen: isOpen, open: open, close: close, Events: Events };