    ...
    return $("body").on("submit", "form", function(event, isValidated) {
        ...
        return $validationFields.each(function() {
            validateField($(this), !0, function($field, result) {
                ...
                if (validatedFields++, showValidationMessage($field, result), result.success && validatedResults++, 
                !scrolledToError && result.success === !1) {
                    scrolledToError = !0;
                    var $label = $("label[for='" + $field.attr("id") + "']");
                    $("html,body").animate({
                        scrollTop: $label.offset().top - 16
                    }, 200);
                }
...
define("neue/main", [ "require", "./carousel", "./events", "./jump-scroll", "./menu", "./messages", "./modal", "./scroll-indicator", "./sticky", "./validation" ], function(require) {
    ...
    var $ = require("jquery"), MediaRadioSelector = function($fieldGroup, opts) {
        if (void 0 !== $fieldGroup && $($fieldGroup.length)) {
            ...
            opts = opts || {}, _this.cfg = opts = {
                ...
                optionSelector: "string" == typeof opts.optionSelector ? opts.optionSelector : ".option"
    ...
    */
    ...
    Validation.registerValidationFunction("phone", function(string, done) {
        ...
        var sanitizedNumber = string.replace(/[^0-9]/g, ""), isValidFormat = /^(?:\+?1([\-\s\.]{1})?)?\(?([0-9]{3})\)?(?:[\-\s\.]{1})?([0-9]{3})(?:[\-\s\.]{1})?([0-9]{4})/.test(string), allRepeatingDigits = /([0-9]{1})\1{9,}/.test(sanitizedNumber);
 ...
 */
define("app", [ "require", "jquery", "finder/Finder", "neue/main", "campaign/sources", "campaign/tips", "campaign/tabs", "campaign/shirts", "campaign/ImageUploader", "validation/auth", "validation/reportback", "validation/address", "Analytics", "tiles" ], function(require) {
    ...
    require("campaign/shirts"), require("campaign/ImageUploader"), require("validation/auth"), 
    require("validation/reportback"), require("validation/address"), require("Analytics"), 
