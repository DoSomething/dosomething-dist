...
define("neue/main", [ "require", "./carousel", "./events", "./jump-scroll", "./media-selector", "./menu", "./messages", "./modal", "./scroll-indicator", "./sticky", "./validation" ], function(require) {
   ...
   */
    ...
    var $cropContainer, xInitPos, yInitPos, offsetLeft, offsetTop, initialCropBoxHeight, initialCropBoxWidth, previewImageWidth, previewImageHeight, $ = require("jquery"), resizeState = !1, dragState = !1, resizeClickPositionX = 0, resizeClickPositionY = 0, $resizeHandle = $("<div class='resize-handle-wrapper'><div class='resize-handle'><div class='resize-triangle'></div></div></div>"), $cropBox = $("<div>").addClass("crop-box").append($resizeHandle), finalCrop = {}, getCoords = function(e) {
        ...
        $previewImage.length && (// Wrap the image in a container to use as a boundary.
        $previewImage.wrap($("<div class='image-crop-container'></div>")), $cropContainer = $(".image-crop-container"), 
        // Add the cropbox to the page.
        $cropBox.insertBefore($previewImage), // Initiate dragging and resizing.
        ...
        $cropContainer.on("touchmove mousemove", function(event) {
            ...
            if (dragState) {
                ...
                var moveRight = offsetLeft + (coords.pageX - xInitPos), moveDown = offsetTop + (coords.pageY - yInitPos);
                ...
                var withinTopBounds = previewImageHeight - cropBoxHeight > moveDown ? !0 : !1, withinLeftBounds = previewImageWidth - cropBoxWidth > moveRight ? !0 : !1;
