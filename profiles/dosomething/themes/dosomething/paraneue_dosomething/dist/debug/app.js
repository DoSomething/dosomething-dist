define("text", {
...
}), define("campaign/ImageUploadBeta", [ "require", "jquery" ], function(require) {
    var $ = require("jquery"), ImageUploadBeta = function() {
        this.$uploadButton = $(".js-image-upload-beta"), this.$cropModal = $("#modal--crop"), 
        this.init();
    };
    /**
   ...
   */
    return ImageUploadBeta.prototype.init = function() {
        ...
        var $btn = this.$uploadButton, $modal = this.$cropModal;
        $btn.on("change", function(event) {
            event.preventDefault();
            var _this = this, files = _this.files ? _this.files : [];
            // If no file selected/no FileReader support, we're all done
            files.length && window.FileReader && // Open Modal
...
}), define("campaign/Reportback", [ "require", "jquery", "campaign/ImageUploadBeta", "revealer/Revealer" ], function(require) {
    var $ = require("jquery"), ImageUploadBeta = require("campaign/ImageUploadBeta"), Reportback = (require("revealer/Revealer"), 
    {
     ...
     */
        init: function($container) {
            $initialGallery = $container.find(".gallery--reportback"), this.$viewMoreButton.insertAfter($initialGallery), 
            this.$viewMoreButton.on("click", this.request), new ImageUploadBeta();
        },
        /**
     * [request description]
