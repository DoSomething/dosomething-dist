   ...
   */
    ...
    */
    ...
    var $ = require("jquery"), Revealer = function($container, $content, category) {
        ...
        this.category = category, this.steps = {
    ...
    return Revealer.prototype.init = function() {
        ...
        if (this.$content.length > 8) for (;collection.length > 0; ) this.steps.items.push(collection.splice(0, 8)); else this.steps.items.push(collection);
        collection = null;
    }, Revealer;
