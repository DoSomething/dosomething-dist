define("text", {
   ...
   */
    ...
    */
    ...
    var $ = require("jquery"), StripeForm = require("StripeForm"), $donateForm = $("#dosomething-payment-form"), // @TODO pull API keys from a config file
    stripeAPIKeys = {
...
define("neue/main", [ "require", "./carousel", "./events", "./jump-scroll", "./media-selector", "./menu", "./messages", "./modal", "./scroll-indicator", "./sticky", "./validation" ], function(require) {
    ...
    var $ = require("jquery"), prepareImageUploadUI = function($context) {
        ...
        $imageUploads.each(function(i, el) {
            ...
            $(el).on("change", function(event) {
                event.preventDefault(), // Change button state
  ...
  */
    function validateCreditCardNumber(string, done, success, failure) {
        for (var key in cardTypes) {
            ...
            return done(card.numberPattern.test(string) ? {
                success: !0,
                message: success
            } : {
                success: !1,
  ...
  */
    ...
    Validation.registerValidationFunction("full_name", function(string, done) {
        ...
        validateCreditCardNumber(string, done, Drupal.t("Credit card number looks good!"), Drupal.t("Invalid credit card number."));
 ...
 */
define("app", [ "require", "jquery", "finder/Finder", "donate/Donate", "neue/main", "campaign/SchoolFinder", "campaign/sources", "campaign/tips", "campaign/tabs", "campaign/ImageUploader", "validation/auth", "validation/reportback", "validation/address", "validation/donate", "Analytics", "tiles" ], function(require) {
    var $ = require("jquery"), Finder = require("finder/Finder"), Donate = require("donate/Donate");
