...
define("text", [ "module" ], function(module) {
   ...
   */
     ...
     **/
        ...
        // @NOTE: Temporarily removing while we sort out Drupal issues.
        ...
        defaultQuery: [ 'q=_query_:"{!func}scale(is_bubble_factor,0,100)"', "fq=-sm_field_campaign_status:(closed) bundle:[campaign TO campaign_group]", //"fq=ss_field_search_image:[* TO *]",
        "wt=json", "indent=false", "facet=true", "facet.field=fs_field_active_hours", "facet.field=im_field_cause", "facet.field=im_field_action_type", "rows=8", "fl=label,tid,im_vid_1,sm_vid_Action_Type,tm_vid_1_names,im_field_cause,im_vid_2,sm_vid_Cause,tm_vid_2_names,im_field_tags,im_vid_5,sm_vid_Tags,tm_vid_5_names,fs_field_active_hours,sm_field_call_to_action,bs_field_staff_pick,ss_field_search_image_400x400,ss_field_search_image_720x720,url" ],
...
define("neue/main", [ "require", "./carousel", "./events", "./jump-scroll", "./menu", "./messages", "./modal", "./scroll-indicator", "./sticky", "./validation" ], function(require) {
    ...
    var $ = require("jquery"), prepareImageUploadUI = (require("neue/events"), function($context) {
