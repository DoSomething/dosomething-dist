...
define("text", [ "module" ], function(module) {
   ...
   */
     ...
     */
        init: function($container, $blankSlateDiv, paginateAction, clearFormAction) {
            ResultsView.$container = $container, ResultsView.$container.hide(), ResultsView.$paginationLink = $("<div class='pagination-link'><a href='#' class='secondary js-finder-show-more'>Show More</a></div>"), 
     ...
     */
        clear: function() {
            ResultsView.checkInit(), ResultsView.$container.empty(), ResultsView.$container.show(), 
            ResultsView.$blankSlateDiv.hide(), ResultsView.slots = 0, ResultsView.start = 0;
        },
        /**
   ...
   */
     ...
     */
        init: function($formDiv, $resultsContainer, $blankSlateDiv) {
            // Initialize the ResultsView
            FormView.init($formDiv, Finder.query), ResultsView.init($resultsContainer, $blankSlateDiv, Finder.query, FormView.clear), 
